  ...
  return (
    <div className="w-full bg-white rounded-2xl p-5 shadow-sm border border-gray-200">
      ...
      <div className="flex justify-between items-start mb-5">
        <h2 className="text-xl font-semibold text-emerald-900">Soil Health Report</h2>
        <button className="flex items-center gap-1 text-white bg-emerald-900 text-xs font-medium px-3 py-1.5 rounded-lg shadow-sm hover:bg-emerald-800 transition-all">
          <Rocket size={14} />
          <span>Start 3-Days Free Tryle</span>
        </button>
      </div>
      ...
      <div className="grid grid-cols-3 gap-3 mb-5">
        {[
          ...
          >
            <h3 className="text-lg font-semibold text-emerald-900">{item.label}</h3>
      ...
      {/* Footer Button */}
      <div className="bg-emerald-900 text-center rounded-xl py-3">

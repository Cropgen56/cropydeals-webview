...
const WeatherCard = () => {
    ...
    const weather =
        JSON.parse(localStorage.getItem("weatherData"))?.currentConditions || {
            temp: null,
            humidity: null,
            pressure: null,
            windspeed: null,
            ...
            <div className="bg-white shadow-md rounded-lg w-[90%] max-w-[360px] md:max-w-[500px] p-3 md:p-5 absolute top-42 font-sans">
                ...
                <div className="flex justify-between items-center flex-wrap gap-y-2">
                    <div className="flex flex-col items-center flex-1 min-w-[23%]">
                        ...
                        <small className="text-[10px] text-teal-700 mt-1">{t("wind")}</small>
                    </div>
                    <div className="flex flex-col items-center flex-1 min-w-[23%]">
                    ...
                    <div className="flex flex-col items-center flex-1 min-w-[23%]  justify-between">
                        ...
                        <small className="text-[10px] text-teal-700 mt-2">{t("pressure")}</small>
                    </div>
                    <div className="flex flex-col items-center flex-1 min-w-[23%]">
                        ...
                        <small className="text-[10px] text-teal-700">{t("precipitation")}</small>
                    </div>
                </div>

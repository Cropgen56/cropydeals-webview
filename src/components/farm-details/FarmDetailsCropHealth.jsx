        ...
        <section className="w-full flex flex-col gap-2 relative">
            ...
            <div className="relative mx-6">
                <div className="flex items-center w-full gap-4 sm:gap-8">
                    <div className="flex-2 h-1 border-b-4 rounded"
                        style={{ borderImageSlice: 1, borderImageSource: "linear-gradient(90deg, #34DB3E 0%, #7DE302 25.25%, #FFE600 50.19%, #FF9600 75.12%, #FF1300 100%)", }}></div>

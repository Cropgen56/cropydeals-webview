...
const FarmDetailsWeatherCard = ({farm}) => {
  ...
  const weatherIcon = getWeatherIcon(derivedCond);
    ...
    const stats = [
    { label: "Wind", value: `${windSpeed} km/h`, image: WindIcon },
    { label: "Humidity", value: `${humidity}%`, image: HumidityIcon },
    { label: "Pressure", value: `${pressure} hPa`, image: PressureIcon },
    { label: "Precipitation", value: `${precipitation} mm`, image: PrecipitationIcon },
  ];
